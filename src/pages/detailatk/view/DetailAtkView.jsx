    ...
    <div className="atk-card group bg-white rounded-lg border border-slate-200/80 overflow-hidden transition-shadow duration-300 hover:shadow-md flex flex-col h-full">
      ...
      <div className="p-4 flex flex-row justify-between items-end flex-grow">
        ...
        <button
          ...
          className="flex-shrink-0 p-2  text-white rounded-lg shadow-md hover:bg-emerald-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500 transition-colors duration-150 disabled:opacity-50 disabled:cursor-not-allowed disabled:bg-slate-400" // <--- Warna diubah
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8 md:gap-12 lg:gap-16">
          ...
          <div className="md:col-span-2">
            ...
            >
              <img
                src={atkDetail.gambar_utama_url || atkDetail.gambar_utama}
            ...
            {atkDetail.deskripsi && (
              <div style={{ marginBottom: 28 }}>
                ...
                <div
                  ...
                  dangerouslySetInnerHTML={{ __html: atkDetail.deskripsi }}
                />
              </div>
            )}
